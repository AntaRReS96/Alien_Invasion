...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Utworzenie egzemplarza przechowującego dane statystyczne.
        ...
        self.play_button = Button(self, msg="Start")

        # Utworzenie egzemplarza przechowującego efekty dźwiękowe.
        self.sounds = Sfx(self)

    def run_game(self):
        """Rozpoczęcice pętli głównej gry"""
        while True:
            self._check_events()
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Usunięcie zawartości list alien i bullets.
            self.aliens.empty()
            self.bullets.empty()
    ...
    def _update_screen(self):
        ...
        # Wyświetlnie informacji o punktacji.
        self.sb.show_score()
